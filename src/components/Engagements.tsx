    ...
    <section id="engagements" className="relative py-28 md:py-40">
      <div className="mx-auto max-w-5xl px-6">
        ...
        >
          ...
          <p className="body-md mt-6 max-w-2xl mx-auto" style={{ color: "#55606f" }}>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {engagements.map((e, i) => (
            ...
            >
              ...
              <p className="body-md mb-8 flex-1" style={{ color: "#55606f" }}>
                {e.deliverable}
              </p>
        ...
        >
          <p className="body-md max-w-2xl mx-auto mb-4" style={{ color: "#55606f" }}>
